...
SYSTEM_PROMPT = (
    ...
    "Dates: map a contract/supply START column (e.g. 'Start Date', 'Contract Start', "
    "'Supply Start', 'Go-live') to supplyStartDate, and a contract/supply END column "
    "(e.g. 'End Date', 'Contract End', 'Supply End', 'Contract Expiry') to supplyEndDate. "
    "These are period boundaries — do NOT map a quote-generated/valid-until/print date to "
    "either. If only one of start or end is present, map that one and leave the other null "
